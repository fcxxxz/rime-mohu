...
local schemas = {
    ...
    { "mohu_zrm_sentence_core.schema.yaml", "mohu_zrm_sentence", "整句·魔虎·自然码", "mohu_zrm_sentence_tiger_prefix2", "mohu_zrm_custom_phrases" },
    ...
    { "mohu_flypy_sentence_core.schema.yaml", "mohu_flypy_sentence", "整句·魔虎·小鹤", "mohu_flypy_sentence_tiger_prefix2", "mohu_flypy_custom_phrases" },
