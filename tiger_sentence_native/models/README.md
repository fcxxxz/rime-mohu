...
`llm-dist` ships this registry metadata only.  Qwen checkpoint weights are
...
| --- | --- | --- | --- | --- |
| `qwen35-0.8b` | `mlx-community/Qwen3.5-0.8B-MLX-4bit` | `tiger/models/Qwen3.5-0.8B-MLX-4bit` | `qwen3_5` | 4-bit |
| `qwen3-0.6b` | `mlx-community/Qwen3-0.6B-4bit` | `tiger/models/Qwen3-0.6B-4bit` | `qwen3` | 4-bit |
